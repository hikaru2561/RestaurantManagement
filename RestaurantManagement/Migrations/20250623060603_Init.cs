    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DingningTableId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsVIP = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DingningTables", x => x.DingningTableId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderItemHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DingningTableId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shifts_Staffs_StaffsStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryUsageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InventoryItemId = table.Column<int>(type: "int", nullable: false),
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryUsages", x => x.InventoryUsageId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryUsages_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryUsages_MenuItemId",
                table: "InventoryUsages",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DingningTableId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_DingningTableId",
                table: "Reservations",
                column: "DingningTableId");

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_StaffsStaffId",
                table: "Shifts",
