...
namespace RestaurantManagement.Areas.Admin.Controllers
{
    ...
    public class DingningTable : Controller
    {
        private readonly ApplicationDbContext _context;

        public DingningTable(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public IActionResult Create(Models.DingningTable model)
        {
        ...
        [HttpPost]
        public IActionResult Edit(Models.DingningTable model)
        {
            if (ModelState.IsValid)
            {
